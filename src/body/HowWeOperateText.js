...
return(
    <div className='flex justify-between items-end mt-0 mx-auto sm:container px-3 md:px-20 mt-20 mb-32'>        <div>
        ...
        <p className='text-[#A4A4A4] mx-auto flex flex-col md:flex-row gap-4 md:gap-6 text-left mb-4 md:mb-6'>At homly we offer the best services,ensuring we have our customers
        needs at hand.</p>
        </div>
